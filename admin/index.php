    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Ta'adud <sup>2025</sup></div>
            </a>
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item">
                <a class="nav-link" href="index.php?page=civitas">
            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Admin Ta'adud</span>
                ...
                <?php
                  // if ($_SESSION['level']== 'Admin') {
                    if (!isset($_GET['page'])) {
                      include 'home.php';
                    }elseif ($_GET['page'] == 'profil' && file_exists('profile.php')) {
                      include 'profile.php';
                    // Pengguna
                    }elseif ($_GET['page'] == 'pengguna' && file_exists('pengguna.php')) {
                      include 'pengguna.php';
                    }elseif ($_GET['page'] == 'tbpengguna' && file_exists('penggunatambah.php')) {
                      include 'penggunatambah.php';
                    }elseif ($_GET['page'] == 'edpengguna' && file_exists('penggunaedit.php')) {
