...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="./">Ta'adud V.1</a>
            <!-- Sidebar Toggle-->
        ...
        <div id="layoutSidenav">
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="index.php?page=civitas">Civitas</a>
                                </nav>
                            </div>
            ...
            if (!isset($_GET['page'])) {
            ...
            } elseif ($_GET['page'] == 'userhapus') {
                include 'userhapus.php';
            } // Civitas
             elseif ($_GET['page'] == 'civitas') {
                include 'civitas.php';
            } elseif ($_GET['page'] == 'civitastambah') {
                include 'civitastambah.php';
            } elseif ($_GET['page'] == 'civitasedit') {
             ...
             elseif ($_GET['page'] == 'pesanan') {
                include 'pesanan.php';
            } elseif ($_GET['page'] == 'pesanantambah') {
                include 'pesanantambah.php';
            } elseif ($_GET['page'] == 'pesanandetail') {
                include 'pesanandetail.php';
            } elseif ($_GET['page'] == 'pesanancetak') {
                include 'pesanancetak.php';
            }  elseif ($_GET['page'] == 'pesananuk') {
               include 'pesananuk.php';
           } 
             // Transaksi Pemesanan
